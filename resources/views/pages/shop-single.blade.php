                    ...
                    <div class="product">
                                    ...
                                    <div class="flexslider">
                                        <div class="slider-wrap" data-lightbox="gallery">
                                            @foreach($product['images'] as $image)
                                                <div class="slide" data-thumb="{{$image}}"><a
                                                            href="{{$image}}" title="{{$product['name']}}"
                                                            data-lightbox="gallery-item"><img src="{{$image}}" alt="{{$product['name']}}"></a>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                        ...
                        <div class="col_two_fifth product-desc">
                            ...
                            <div class="panel panel-default product-meta">
                                <div class="panel-body">
                                    ...
                                    <span class="tagged_as">Tags: <a href="#" rel="tag">Pink</a>, <a href="#" rel="tag">Short</a>, <a
                        ...
                        <div class="col_one_fifth col_last">
                            ...
                            <a href="#" title="Brand Logo" class="hidden-xs"><img class="image_fade"
                                                                                  src="{{asset('images/beanalli-black.png')}}"
                                                                                  alt="Brand Logo"></a>
                            ...
                            <div class="tabs clearfix nobottommargin" id="tab-1">
                                ...
                                <ul class="tab-nav clearfix">
                                    ...
                                    <li><a href="#tabs-3"><i class="icon-star3"></i><span
                                                    class="hidden-xs"> Reviews (2)</span></a></li>
                                </ul>
